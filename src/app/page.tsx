...
export default function Home() {
    ...
    const handleFileChange = async (e : any) => {
        ...
        setLabelText( labelText === 'Upload' ? 'Upload ': 'Upload'  );
    ...
    useEffect(() => {
        ...
        async function fetchPositionsAndTokenData() {
            ...
            setPositions(responsePositin.positions);      
            const responseToken = await GetTokenData();
            setToken(responseToken);
        }
        fetchPositionsAndTokenData()

        const fileUpload = document.getElementById('file-upload');
        const fileUploadLabel = document.querySelector('.file-upload-label');
        const fileUploadText = document.querySelector('.file-upload-text');
    
        if (fileUpload && fileUploadLabel && fileUploadText) {
          fileUpload.addEventListener('change', function(e) {
            const target = e.target as HTMLInputElement;
            if (target) {
              const fileName = target.value.split('\\').pop();
              fileUploadLabel.textContent = fileName ? fileName : 'Upload';
              fileUploadText.innerHTML = fileName ? '' : 'Upload your photo';
            }
          });
        }      
              ...
              <nav>
                  <div className="logo" onClick={scrollToPostSection}>
                      ...
                      >
                          ...
                          />
                          <path
                              d="M11.4389 17.9422C11.4447 18.0677 11.3468 18.1736 11.2191 18.1793L8.3912 18.3047L8.14951 18.3162L7.90896 18.3264L5.09489 18.4519H5.08453C4.96253 18.4519 4.8601 18.356 4.8555 18.2341C4.84974 18.1075 4.94757 18.0015 5.07417 17.9958L8.0344 17.8647L8.2761 17.8545L8.51665 17.8431L11.1984 17.7245C11.3284 17.7176 11.4331 17.8157 11.4389 17.9422Z"
                              fill="black"
                              fillOpacity="0.87"
                          />
                          <path
                              d="M32.8614 13.1424L29.7297 14.3417L29.5144 14.4238L29.2981 14.507L27.1435 15.3313C27.1159 15.3416 27.0882 15.3472 27.0606 15.3472C26.9686 15.3472 26.881 15.2914 26.8454 15.2013C26.7994 15.0839 26.8592 14.9517 26.9777 14.9061L29.1772 14.0635L29.3936 13.9814L29.6088 13.8982L32.6956 12.7172C32.813 12.6716 32.9477 12.7297 32.9938 12.8471C33.0387 12.9646 32.98 13.0968 32.8614 13.1424Z"
                              fill="black"
                              fillOpacity="0.87"
                          />
                          <path
                              d="M33.8567 15.8273C33.867 15.9527 33.7727 16.0633 33.646 16.0735L30.2749 16.3529L30.0424 16.3723L29.8088 16.3916L27.5368 16.5797H27.5173C27.3999 16.5797 27.2986 16.4897 27.2882 16.3711C27.2778 16.2457 27.3723 16.1351 27.4988 16.1248L29.6868 15.9436L29.9204 15.9242L30.1529 15.906L33.608 15.6198C33.7347 15.6072 33.8463 15.7018 33.8567 15.8273Z"
                              fill="black"
                              fillOpacity="0.87"
                          />
                          <path
                              d="M33.865 18.2338C33.8591 18.3558 33.7579 18.4516 33.6348 18.4516H33.6243L30.8103 18.3262L30.571 18.3159L30.3293 18.3045L27.5003 18.1792C27.3736 18.1734 27.2746 18.0674 27.2803 17.942C27.2862 17.8154 27.3908 17.7196 27.521 17.7243L30.2038 17.8428L30.4443 17.8542L30.6848 17.8645L33.6452 17.9955C33.7728 18.0012 33.8707 18.1073 33.865 18.2338Z"
                              fill="black"
                              fillOpacity="0.87"
                          />
                          <path
                              d="M25.9208 23.5796C26.0087 23.8304 26.0849 24.136 26.1092 24.486C26.1381 24.8976 26.0861 25.2555 26.0144 25.5393L25.9208 23.5796Z"
                              fill="white"
                          />
                          <path
                              d="M26.0154 25.7672C25.997 25.7672 25.9785 25.7649 25.9602 25.7604C25.8371 25.7306 25.7611 25.6064 25.7922 25.4845C25.8727 25.1595 25.9027 24.8289 25.8796 24.5017C25.86 24.2178 25.8002 23.9328 25.7035 23.6546C25.662 23.5361 25.7254 23.4061 25.8462 23.3651C25.9671 23.324 26.0971 23.3867 26.1385 23.5065C26.249 23.8222 26.3158 24.1471 26.3388 24.4709C26.3653 24.846 26.3307 25.2233 26.2387 25.595C26.2122 25.6976 26.1178 25.7672 26.0154 25.7672Z"
                              fill="black"
                              fillOpacity="0.87"
                          />
                          <path
                              d="M27.4217 23.4893C27.5627 23.7139 27.6853 23.9874 27.7234 24.3009C27.7697 24.6692 27.6865 24.9896 27.572 25.2449L27.4217 23.4893Z"
                              fill="white"
                          />
                          <path
                              d="M27.5715 25.4718C27.5404 25.4718 27.5093 25.465 27.4782 25.4524C27.362 25.4011 27.309 25.2666 27.3608 25.1515C27.4829 24.8779 27.5266 24.6008 27.4932 24.3272C27.4632 24.0878 27.3736 23.8461 27.2251 23.6078C27.1583 23.5007 27.1916 23.3604 27.2999 23.2943C27.4081 23.2282 27.5497 23.2613 27.6164 23.3684C27.8006 23.6625 27.9121 23.967 27.9501 24.2725C27.9939 24.6282 27.9375 24.9862 27.7821 25.3361C27.7441 25.4217 27.6601 25.4718 27.5715 25.4718Z"
                              fill="black"
                              fillOpacity="0.87"
                          />
                          <path
                              d="M12.803 23.5796C12.7152 23.8304 12.6388 24.136 12.6145 24.486C12.5857 24.8976 12.6377 25.2555 12.7093 25.5393L12.803 23.5796Z"
                              fill="white"
                          />
                          <path
                              d="M12.707 25.7673C12.6035 25.7673 12.5102 25.6976 12.4838 25.594C12.3916 25.2235 12.3571 24.845 12.3836 24.4698C12.4054 24.145 12.4734 23.8211 12.5839 23.5054C12.6254 23.3868 12.7566 23.3229 12.8762 23.364C12.9959 23.405 13.0603 23.535 13.0189 23.6536C12.9222 23.9317 12.8624 24.2156 12.8429 24.5006C12.8198 24.8278 12.8498 25.1585 12.9303 25.4834C12.9602 25.6054 12.8854 25.7296 12.7623 25.7593C12.7438 25.765 12.7255 25.7673 12.707 25.7673Z"
                              fill="black"
                              fillOpacity="0.87"
                          />
                          <path
                              d="M11.3021 23.4893C11.1611 23.7139 11.0386 23.9874 11.0004 24.3009C10.9542 24.6692 11.0374 24.9896 11.1518 25.2449L11.3021 23.4893Z"
                              fill="white"
                          />
                          <path
                              d="M11.1509 25.4718C11.0622 25.4718 10.9782 25.4205 10.9402 25.3361C10.7849 24.9872 10.7273 24.6293 10.7722 24.2725C10.8102 23.967 10.9218 23.6637 11.106 23.3684C11.1727 23.2613 11.3143 23.2282 11.4225 23.2943C11.5307 23.3604 11.5641 23.5007 11.4973 23.6078C11.3488 23.845 11.2591 24.0878 11.2291 24.3272C11.1958 24.6008 11.2395 24.8779 11.3615 25.1515C11.4133 25.2666 11.3604 25.4011 11.2441 25.4524C11.213 25.4661 11.1819 25.4718 11.1509 25.4718Z"
                              fill="black"
                              fillOpacity="0.87"
                          />
                          <path
          ...
          <main>
              <article>
                  ...
                  <section className="get-section">
                      ...
                      {nextPageUrl ? (
                          <button
                              className="hero-button show-more-button"
                  ...
                  <section className="post-section">
                      ...
                      >
                              ...
                              <input
                                  {...register("email", {
                                      ...
                                      minLength: {
                                          value: 2,
                                          message:
                                              "Email should contain 2-100 characters",
                                      },
                                      maxLength: {
                                          value: 100,
                                          message:
                          ...
                          <fieldset className="post-position">
                              ...
                              {positions.map((position, index) => {
                                  ...
                                  return (
                                      <div
                                          className="fieldset-input-wrapper"
                                          key={position.name}
                                      >
                                          <input
                                              {...register(
